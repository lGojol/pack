...
class LoadingWindow(ui.ScriptWindow):
	...
	def __RegisterColor(self):
		...
		if app.TOURNAMENT_PVP_SYSTEM:
			NAME_COLOR_DICT.update({chrmgr.NAMECOLOR_TOURNAMENT_TEAM_A : colorInfo.CHR_NAME_RGB_TOURNAMENT_A,})
			NAME_COLOR_DICT.update({chrmgr.NAMECOLOR_TOURNAMENT_TEAM_B : colorInfo.CHR_NAME_RGB_TOURNAMENT_B,})

		if app.CRYSTAL_EVENT_SYSTEM:
			NAME_COLOR_DICT.update({chrmgr.NAMECOLOR_CRYSTAL_RED : colorInfo.CHR_NAME_RGB_TOURNAMENT_A,})
			NAME_COLOR_DICT.update({chrmgr.NAMECOLOR_CRYSTAL_BLUE : colorInfo.CHR_NAME_RGB_TOURNAMENT_B,})

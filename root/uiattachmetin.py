...
class AttachMetinDialog(ui.ScriptWindow):
	...
	def Open(self, metinItemPos, targetItemPos):
		...
		self.oldToolTip.AddItemData(itemIndex, metinSlot, 0, None, 0, 0, player.INVENTORY, -1, None, apply_random_list, set_value)
		...
		self.newToolTip.AddItemData(itemIndex, metinSlot, 0, None, 0, 0, player.INVENTORY, -1, None, apply_random_list, set_value)

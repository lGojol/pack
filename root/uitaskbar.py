...
class ExpandedTaskBar(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		if app.ENABLE_CHEQUE_EXCHANGE_WINDOW:
			self.toggleButtonDict[ExpandedTaskBar.BUTTON_WON_EXCHANGE] = self.GetChild("ExchangeButton")
			self.toggleButtonDict[ExpandedTaskBar.BUTTON_WON_EXCHANGE].SetParent(self)

		if app.ENABLE_AUTO_SYSTEM_OFFICAL:
			import chrmgr
		...
		try:
			...
			if app.ENABLE_GEM_SYSTEM:
				if localeInfo.IsARABIC():
					...
					pyScrLoader.LoadScriptFile(self, "UIScript/newtaskbar.py")
			else:

...
def __LoadGameEffect():
	...
	if app.ENABLE_CONQUEROR_LEVEL:
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+45, "", "d:/ymir work/pc/shaman/effect/chunwoon_4_target.mse") ## ?? - ??
		chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+46, "Bip01", "d:/ymir work/pc/shaman/effect/chunwoon_moojuk.mse")
	...
	if app.ENABLE_QUIVER_SYSTEM:
		effect.RegisterIndexedFlyData(effect.FLY_QUIVER_ATTACK_NORMAL, effect.INDEX_FLY_TYPE_NORMAL, "d:/ymir work/pc/assassin/effect/arrow_02.msf")		## ?? ??? ??? 1
	if app.ENABLE_CONQUEROR_LEVEL:

							...
							(
								{
									...
									"slot" :	(
										{"index": BUFF_EQUIPMENT_START_INDEX+0, "x":  22, "y":  60, "width":32, "height":32},# Weapon
										{"index": BUFF_EQUIPMENT_START_INDEX+1, "x": 72, "y": 24, "width":32, "height":32},# Costume Hair
										{"index": BUFF_EQUIPMENT_START_INDEX+2, "x": 72, "y":  60, "width":32, "height":64},# Costume Armor
										{"index": BUFF_EQUIPMENT_START_INDEX+3, "x":38, "y":  7, "width":32, "height":32},# Costume Acce
										{"index": BUFF_EQUIPMENT_START_INDEX+4, "x":3, "y":  7, "width":32, "height":32},# Costume Aura
										{"index": BUFF_EQUIPMENT_START_INDEX+5, "x":25, "y":  95, "width":32, "height":32}, # Costume Ring
									),
								},
							),
						},
						...
						{ 
							...
							(
								...
								{ "name" : "preview_upgrade_skill_slot", "type" : "slot", "x" : 43, "y" : 39, "width" : 32, "height" : 32, "slot" :	( {"index": 0, "x":  0, "y":  0, "width":32, "height":32}, ), },
								{
									...
									"slot" :	(
										{"index": BUFF_EQUIPMENT_START_INDEX+6, "x": 0, "y":  0, "width":32, "height":32},
										{"index": BUFF_EQUIPMENT_START_INDEX+7, "x": 52, "y": 0, "width":32, "height":32},
										{"index": BUFF_EQUIPMENT_START_INDEX+8, "x": 104, "y":  0, "width":32, "height":32},
									),
								},
								{
								...
								
								{
									...
									"slot" :	(
										{"index": BUFF_EQUIPMENT_START_INDEX+9, "x":  0, "y":  0, "width":32, "height":32},
										{"index": BUFF_EQUIPMENT_START_INDEX+10, "x": 129, "y": 0, "width":32, "height":32},
										{"index": BUFF_EQUIPMENT_START_INDEX+11, "x": 258, "y":  0, "width":32, "height":32},
									),
								},
